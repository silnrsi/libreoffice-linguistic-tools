...
#
#   12-Aug-11 JDK  Added OtherKnownChars. LetterIndex only has one value.

"""
Contains unicode consonants and vowels for each script.

ScriptLetters and OtherKnownChars are generated from
