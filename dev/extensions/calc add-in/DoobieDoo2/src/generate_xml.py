...
addin_id = "com.doobiecompany.examples.DoobieDoo"
addin_version = "0.25"
addin_displayname = "The doobie-tastic Add-In example."
addin_publisher_link = "http://www.doobiecompany.com"
addin_publisher_name = "Doobie Company"
...
add_manifest_entry(manifest_xml, 'uno-typelibrary;type=RDB', 'XDoobieDoo.rdb')
add_manifest_entry(manifest_xml, 'configuration-data', 'CalcAddIn.xcu')
add_manifest_entry(manifest_xml, 'uno-component;type=Python', 'doobiedoo.py')
manifest_xml.write('</manifest:manifest> \n')
...
instance_id = "com.doobiecompany.examples.DoobieDoo.python.DoobieDooImpl"
...
define_function(calcaddin_xml, \
	'doobieMult', 'Multiplies two integers quite fantastically.', \
	[('a', 'The first integer.'), ('b', 'The second integer.')])
define_function(calcaddin_xml, \
	'doobieDiv', 'Divides two floating point numbers in a marvellous way.', \
	[('a', 'The first floating point number.'), ('b', 'The second floating point number.')])
define_function(calcaddin_xml, \
	'doobieConcat', 'Concatenates two strings without hesitation.', \
	[('s1', 'The first string.'), ('s2', 'The second string.')])
define_function(calcaddin_xml, \
	'doobieConcatOptional', 'Concatenates two, perhaps three, strings without further ado.', \
	[('s1', 'The very first string.'), ('s2', 'The second, or middle, string.'), ('s3', 'The third string which may, or may not be, present.')])
